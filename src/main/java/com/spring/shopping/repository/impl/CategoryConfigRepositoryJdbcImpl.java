...
public class CategoryConfigRepositoryJdbcImpl implements CategoryConfigRepository {
	...
	public List<Product> getProductsByCategory(String categoryName) {
		String sql = "SELECT * FROM product p where p.Category_Id = (SELECT c.Category_Id FROM category c where c.categoryName = :categoryName)";
		SqlParameterSource sqlParameterSource = new MapSqlParameterSource(
	...
	public Integer insertCategory(Category ca) {
		...
		SqlParameterSource sqlParameterSource = new BeanPropertySqlParameterSource(ca);
	...
	public Integer editCategory(Category ca) {
		// TODO Auto-generated method stub
		String sql = "update category  set categoryNmae=:newName where categoryName=:categoryName";
		SqlParameterSource sqlParameterSource = new BeanPropertySqlParameterSource(ca);
		return namedParameterJdbcTemplate.update(sql, sqlParameterSource);
	}
