...
<body>
	...
	<section>
		<div class="container">
			<div class="row">
			<hr class="prettyline">
			<h4><b> SubCategory Name</b></h4>
			<hr class="prettyline">
			<h4>Select Category</h4>
			
			
			
				<c:forEach var="fe" items="${featP}">
	      
	<c:out value="${fe.name}" />
	<c:out value="${fe.manufacturer}" />
    </c:forEach>
	<select>		
	<c:forEach var="fea" items="${fe}">
	<option>
	<c:out value="${fea.categoryName}" /></option>
    </c:forEach>
	</select>
	...
	<h4><b>SubCategory Name  </b></h4>
				...
				<c:forEach var="featProds" items="${featProd}">
				                       <p class="group inner list-group-item-text">
												...
												<c:out value="${featProds.subCategoryName}" />
