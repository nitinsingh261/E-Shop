					...
					<li class="dropdown"><a href="${url}" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							<c:forEach var="subCategory" items="${categories.value}">
								<li class="divider"></li>
								<c:url var="subCaturl" value="subcateogryName">
									<c:param name="subcategoryName"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<a href="shopregistration" Style="background-color:aqua; ">Register Shop</a>
						<a href="admin" Style="background-color:red; "> Admin</a>
					</c:otherwise>
				</c:choose>
			</ul>
		</div>
